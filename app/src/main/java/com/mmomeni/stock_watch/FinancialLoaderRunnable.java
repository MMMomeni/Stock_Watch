...
public class FinancialLoaderRunnable implements Runnable {
    ...
    FinancialLoaderRunnable(MainActivity mainActivity, String s) {
    ...
    @Override
    public void run() {
        String DATA_URL = "https://cloud.iexapis.com/stable/stock/"+ symbl +"/quote?token=pk_f2955502fbdd48718146ef719b5cd70e";
